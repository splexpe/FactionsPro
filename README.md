...
## What is this branch?
This branch is called the "new-implementations" branch, a newest, but mostly stabled branch based on implementing new features, and bug fixes along the way as well. We like to listen to your suggestions, and try to add them to this plugin.
