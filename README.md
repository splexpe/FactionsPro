...
## What is this branch?
This branch is called "old-methods". What this branch does, is it allows us to support old-server software based on methods within the code, such as the onCommand method, to the old command-method. Everything in this branch will be based on old-methods within this plugin. Such as steadfast.
