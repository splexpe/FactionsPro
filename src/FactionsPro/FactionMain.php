...
class FactionMain extends PluginBase implements Listener {
	...
	public const TESTED_MIN_POCKETMINE_VERSION = "1.7dev-1206"; // The minimum build this was tested working
	public const TESTED_MAX_POCKETMINE_VERSION = "1.7dev-1230"; // The current build this was actually tested
